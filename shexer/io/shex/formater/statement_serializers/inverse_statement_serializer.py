from shexer.io.shex.formater.statement_serializers.base_statement_serializer import BaseStatementSerializer, SPACES_GAP_BETWEEN_TOKENS
...
class InverseStatementSerializer(BaseStatementSerializer):
    ...
    def _add_inverse_sense_to_first_tuple(self, statement_str_indent_tuples):
        ...
        :return:
        """
        statement_str_indent_tuples[0] = _INVERSE_SENSE_SHEXC + \
                                         SPACES_GAP_BETWEEN_TOKENS + \
                                         statement_str_indent_tuples[0]
